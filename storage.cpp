...
bool Storage::pop(int &data)
{
    ...
    {
        cout << "Det poppade elementet är " << head->data << endl;
...
bool Storage::peek(int &data)
{
    ...
    else
    {
        ...
        cout << "Toppelementet är " << newNode->data << endl;
        return true;
    }
}
...
bool Storage::swap(int i, int j)
{
    ...
    if(p1 && p2 == NULL)
    {
        cerr << "Bytet är inte möjligt" << endl;
        return false;
    }
...
void Storage::printList()
{
    ...
    if(head == NULL)
    {
        cerr << "Stacken är tom" << endl;
    }
    else
    {
        // Traverse the list
        cout << "Stackelement är: ";
        cout << "None -> ";
        while(temp != NULL)
        {
            cout << temp->data << " -> ";
